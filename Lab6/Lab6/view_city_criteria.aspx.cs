...
namespace Lab6
{
    public partial class view_city_criteria : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand view = new SqlCommand("viewcriteriacity", conn);
            ...
            while (rdr.Read())
            {
                ...
                namee.Text = name;
                namee.NavigateUrl = "view_city_rating.aspx?cname=" + name;
