...
namespace Lab6
{
    public partial class view_hotel_criteria : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand view = new SqlCommand("viewcriteriahotel", conn);
            ...
            while (rdr.Read())
            {
                ...
                namee.Text = name;
                namee.NavigateUrl = "view_hotel_rating.aspx?cname=" + name;
